    ...
    <div id="view-workflow">
        <div class="tablenav">
            <ul class="subsubsub">
				...
				echo '<li class="all"><a href="admin.php?page=oasiswf-admin"' . esc_attr( $all_val ) . ' >' .
					...
					foreach ( $workflows as $wf ) {
						...
						if ( $count >= $start ) {
							...
							echo "<th scope='row' class='check-column'><input type='checkbox' name='workflows[]' value='" .
							     esc_attr( $wf->ID ) . "'></th>";
							echo "<td class='column-primary' data-colname='Workflow ID'>" . esc_attr( $wf->ID ) .
							...
							echo "<div class='bold-label' id=" . "workflow-name-" . esc_attr( $wf->ID ) .
							     ">" . esc_attr( $wf->name ) . "</div>";
							echo "<span class='" . esc_attr( $content ) . "'>" . esc_attr( $datadesc ) . "</span></a>";
							...
							echo "<td data-colname='Version'>" . esc_attr( $wf->version ) . "</td>";
							...
							echo "<td data-colname='Post/Pages in workflow'>" . esc_attr( $postcount ) . "</td>";
							echo "<td data-colname='Is Valid?'>" . esc_attr( $valid ) . "</td>";
							echo "</tr>";
						}
						$count ++;
					}
