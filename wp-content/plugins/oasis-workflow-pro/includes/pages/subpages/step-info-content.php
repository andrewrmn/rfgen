...
<div id="step-setting">
        ...
        <div>
            <div style="margin-left:0px;">
                <label>
                    ...
                    <a href="#"
                       title="<?php echo esc_html__( 'Check this box to assign the task to all the users in this step and hide the assignee list during the sign off process.',
						   "oasisworkflow" );
                       ?>"
                       class="tooltip">
                      <span title="">
        ...
        <div class="first-step-post-status owf-hidden ow-fieldset">
            <fieldset class="first-step-fieldset">
                ...
                <label><?php echo esc_html__( 'Post Status: ', 'oasisworkflow' ); ?>
                    <a href="#" title="<?php echo esc_html__( 'Post Status after submit to workflow.', "oasisworkflow" );
					?>" class="tooltip">
                       <span title="">
                           <img src="<?php echo esc_url( OASISWF_URL . 'img/help.png' ); ?>" class="help-icon"/>
                       </span>
                ...
                <fieldset class="last-step-fieldset">
                    ...
                    <select name="last_step_post_status" id="last_step_post_status">
						...
						<?php foreach ( $status_array as $status_id => $status_object ) {
							...
							?>
                            <option value="<?php echo esc_attr( $status_id ); ?>" <?php selected( $status_id,
								$selected_status ); ?>><?php echo esc_attr( $status_object->label ); ?></option>
						<?php } ?>
                    </select>
                    <br class="clear">
                </fieldset>
        ...
        <div>
            <div style="margin-left:0px;">
                <label><?php echo esc_html__( 'Sign off Action Text: ', 'oasisworkflow' ); ?>
                    <a href="#"
                       title="<?php echo esc_html__( 'Specify the text for sign off actions that should appear when user is signing off from a given task.',
						   "oasisworkflow" );
					   ?>" class="tooltip">
                  <span title="">
                     <img src="<?php echo esc_url( OASISWF_URL . 'img/help.png' ); ?>" class="help-icon"/>
                ...
                <div>
                    ...
                    <div class="left">
                        ...
                        <input type="button" id="addPlaceholderAssignmentSubj" class="button-primary placeholder-add-bt"
                               value="<?php echo esc_html__( "Add to subject", "oasisworkflow" ); ?>"
                               style="margin-left:20px;"/>
                        <input type="button" id="addPlaceholderAssignmentMsg" class="button-primary placeholder-add-bt"
                               value="<?php echo esc_html__( "Add to message", "oasisworkflow" ); ?>"
                               style="margin-left:20px;"/>
                    </div>
                    <br class="clear">
                </div>
    ...
    <br class="clear">
    <p class="step-set">
        <input type="button" id="stepSave" class="button-primary" value="<?php echo esc_html__( "Save", "oasisworkflow" ); ?>"/>
        <span>&nbsp;</span>
