...
if ( $workflows ) {
	...
	if ( isset( $_GET['post'] ) ) {
		$post_id = intval( $_GET['post'] ); // phpcs:ignore WordPress.Security.NonceVerification
            ...
            <div class="owf-text-info left full-width">
                <div class="left">
                    <label><?php echo esc_html( $due_date_label ) . " : "; ?>
                        <a href="#" title="<?php echo esc_html__( 'Specify a date for the assignment to be completed.',
            ...
            <div class="owf-text-info left full-width">
                <div class="left">
                    <label><?php echo esc_html( $publish_date_label ) . " : "; ?>
                        <a href="#"
                           title="<?php echo esc_html__( 'Specify a desired publish date for the post.',
	                           "oasisworkflow" ); ?>"
                           class="tooltip">
                     <span title="">
                        <img src="<?php echo esc_url( OASISWF_URL . '/img/help.png' ); ?>" class="help-icon"/></span>
