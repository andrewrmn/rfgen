                ...
                <div class="postbox-container" id="process-info-div">
                    <div class="postbox">
                        ...
                        <h3 style="padding:7px;">
                       	...
                       	<a href="#"
                           title="<?php echo esc_html__( 'Drag and Drop the processes into the Workflow Design Canvas to create new workflow steps.',
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                     ...
                                     <a href="#"
                                        title="<?php echo esc_html__( 'End date is not required. If not specified, the workflow is valid for ever.
        ...
        <div class="save-action-div">
			...
			<?php if ( $wf_editable ) { ?>
				...
				if ( current_user_can( 'ow_edit_workflow' ) ) {
					?>
                    <input type="button" value="<?php echo esc_html__( "Save and Close", "oasisworkflow" ) ?>"
                           class="button-primary workflow-save-close-button" data-bname="save-close">
                    <input type="button" value="<?php echo esc_html__( "Save", "oasisworkflow" ) ?>"
				...
				if ( current_user_can( 'ow_create_workflow' ) ) {
					?>
                    <input type="button" value="<?php echo esc_html__( "Copy" ) ?>"
