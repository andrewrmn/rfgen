...
$action = ( isset( $_REQUEST["action"] ) && sanitize_text_field( $_REQUEST["action"] ) ) ? sanitize_text_field( $_REQUEST["action"] ) : "inbox-mine"; // phpcs:ignore
							...
							foreach ( $assigned_users as $assigned_user ) {
								if ( ( isset( $_GET['user'] ) && $_GET["user"] == $assigned_user->ID ) ) { // phpcs:ignore
									echo "<option value=" . esc_attr( $assigned_user->ID ) .
									     " selected> " . esc_attr( $assigned_user->display_name ) . "</option>";
								} else {
									echo "<option value=" . esc_attr( $assigned_user->ID ) .
									     ">" . esc_attr( $assigned_user->display_name ) . "</option>";
								}
							}
						}
						?>
