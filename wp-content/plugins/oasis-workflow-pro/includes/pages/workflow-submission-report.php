            ...
            <div class="tablenav bottom">
                ...
                <div class="alignleft actions">
                    <select name="action_type" id="action_type">
                        <option value="none"><?php esc_html_e( "-- Select Action --" ); ?></option>
                        <option value="abort"><?php esc_html_e( "Abort" ); ?></option>
                    </select>
                    <input type="button" class="button action" id="apply_action" value="<?php esc_html_e('Apply', 'oasisworkflow'); ?>"><span
