			...
			if ( $histories ):
				foreach ( $histories as $row ) {
					...
					if ( $row->assign_actor_id != - 1 ) { //assignment and/or publish steps
						...
						echo "<td data-colname='Result'>" . esc_attr( $ow_process_flow->get_sign_off_status( $row ) ) .
						     "</td>";
						...
						if ( $review_rows ) {
							foreach ( $review_rows as $review_row ) {
								...
								if ( ! in_array( $current_user_role, $user_roles ) ) {
									...
									echo "<td data-colname='Actor'>" . esc_attr( $actor ) . "</td>";
								}
								...
								echo "<td data-colname='Result'>" . esc_attr( $review_status ) . "</td>";
								echo "<td class='comments column-comments' data-colname='Comments'>
												<div class='post-com-count-wrapper'>
													<strong>
