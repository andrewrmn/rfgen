	...
	<table id="wlm-webhooks-outgoing" class="wlm-webhooks table table-striped">
		...
		<thead>
			<tr>
				...
				<th class="text-center"><?php _e( 'Add', 'wishlist-member' ); ?></th>
				<th class="text-center"><?php _e( 'Remove', 'wishlist-member' ); ?></th>
				<th class="text-center"><?php _e( 'Cancel', 'wishlist-member' ); ?></th>
				<th class="text-center"><?php _e( 'Uncancel', 'wishlist-member' ); ?></th>
				<th></th>
			</tr>
		</thead>
	</table>
