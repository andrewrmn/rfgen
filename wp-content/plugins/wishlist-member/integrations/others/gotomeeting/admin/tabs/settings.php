<p><?php _e( 'Ensure that First Name, Last Name and Email Address are the only required fields in the GoToWebinar settings.', 'wishlist-member' ); ?></p>
<p><?php _e( 'Assign the Membership Levels to the corresponding Webinars. Membership Levels can be assigned to Webinars by entering the Registration URL of the webinar in the corresponding GoToWebinar Registration URL field below.', 'wishlist-member' ); ?></p>
