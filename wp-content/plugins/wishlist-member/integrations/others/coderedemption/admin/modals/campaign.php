	...
	<div class="body">
		<form>
			...
			<ul class="nav nav-tabs edit-only">
				<li class="nav-item">
					<a class="show-modal-footer nav-link" data-toggle="tab" href="#coderedemption-campaign-modal-settings"><?php _e( 'Settings', 'wishlist-member' ); ?></a>
				</li>
				<li class="nav-item">
					<a class="generate-code nav-link" data-toggle="tab" href="#coderedemption-campaign-modal-codes"><?php _e( 'Codes', 'wishlist-member' ); ?></a>
				</li>
				<li class="nav-item">
					<a class="show-modal-footer nav-link" data-toggle="tab" href="#coderedemption-campaign-modal-actions"><?php _e( 'Actions', 'wishlist-member' ); ?></a>
				</li>
			</ul>
