		...
		<template class="wlm3-form-group">
			{
				...
				column : 'col-md-9',
				class : 'applycancel',
				help_block : '<?php _e( 'Copy the Secret Key and paste it into RedOakCart in the following section: Setup > Membership Sites > Secret Key.', 'wishlist-member' ); ?>',
		...
		<template class="wlm3-form-group">
			{
				...
				help_block : '<?php _e( 'Copy the Post To URL and paste it into RedOakCart in the following section: Setup > Membership Sites > URL.', 'wishlist-member' ); ?>',
