	...
	<div class="body">
		<div class="row -integration-keys">
			...
			<template class="wlm3-form-group">
				{
					label : '<?php _e( 'Recurly Private API Key', 'wishlist-member' ); ?>',
					name : 'recurlyapikey',
					column : 'col-md-12',
					tooltip : '<?php _e( 'The Private API key can be found in the <em>Integrations > API Credentials</em> section of Recurly.', 'wishlist-member' ); ?>',
					tooltip_size : 'lg',
				}
			</template>
			<!-- <div class="col-md-2">
