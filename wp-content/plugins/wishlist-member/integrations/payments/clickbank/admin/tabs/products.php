<div class="table-wrapper">
	<table id="clickbank-products" class="table table-striped">
		...
		<thead>
			<tr>
				<th class="text-center"><?php _e( 'Item ID', 'wishlist-member' ); ?></th>
				<th><?php _e( 'Access', 'wishlist-member' ); ?></th>
				<th><?php _e( 'Payment Link', 'wishlist-member' ); ?></th>
				<th></th>
			</tr>
		</thead>
		<tfoot>
...
<div
	...
	data-title="Editing <?php echo $config['name']; ?> Product for <span></span>"
	...
	<div class="body">
		...
		<div class="row">
			...
			<template class="wlm3-form-group">
				{
					label : '<?php _e( 'Clickbank Product ID', 'wishlist-member' ); ?>',
					type : 'text',
					name : 'id',
					column : 'col-6',
				}
