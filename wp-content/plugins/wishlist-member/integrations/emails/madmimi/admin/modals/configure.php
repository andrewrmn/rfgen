<div
	...
	<div class="body">
		<div class="row -integration-keys">
			...
			<div class="col-md-12">
				<p><?php _e( 'API Credentials are located in the Mad Mimi account under Account > API', 'wishlist-member' ); ?></p>
			</div>
			<template class="wlm3-form-group">{label : '<?php _e( 'Username/Email', 'wishlist-member' ); ?>', type : 'text', name : 'username', column : 'col-md-12'}</template>
