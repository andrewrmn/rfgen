		...
		<tfoot>
		  ...
		  <tr>
				<td colspan="10" class="text-center pt-3">
				  <a href="#fluentcrm-tag-modal" data-toggle="modal" data-tag-id="new" class="btn -success -condensed"><i class="wlm-icons">add</i><?php _e( 'Add Tag Action', 'wishlist-member' ); ?></a>
				</td>
		  </tr>
		</tfoot>
	</table>
		...
		<tr class="button-hover">
			...
			<td class="text-right">
				<div class="btn-group-action">
					<a href="#" data-toggle="modal" data-target="#fluentcrm-tag-modal" data-tag-id="<%- tag_id %>" class="btn -tag-btn" title="<?php _e( 'Edit Tag Actions', 'wishlist-member' ); ?>"><i class="wlm-icons md-24">edit</i></a>
