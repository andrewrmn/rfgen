...
#shortcode-creator-modal .wlm-shortcode-attributes [data-dependency] {
	display: none;
}
...
<div
	...
	data-title="<?php _e( 'Shortcode Creator', 'wishlist-member' ); ?>"
  data-classes="modal-lg"
	style="display:none">
	<div class="body">
    <div class="row">
			<div class="col-12">
				<?php wishlistmember_instance()->wlmshortcode->_render_shortcode_menu(); ?>
			</div>
		</div>
