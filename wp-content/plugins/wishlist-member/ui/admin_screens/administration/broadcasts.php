...
if (is_numeric(wlm_arrval($_GET, 'howmany')) || !$howmany || wlm_arrval($_GET, 'howmany') == "Show All" ) {
	...
	if ( $howmany != "Show All" ) $this->SaveOption('broadcast_page_pagination', $howmany);
}

// pagination
$offset = $_GET['offset'] - 1;
if ( $offset < 0 ) $offset = 0;
$perpage = $howmany == "Show All" ? 999999999 : $howmany;
...
$form_action = "?page={$this->MenuID}&wl=" . ( isset( $_GET['wl'] ) ? $_GET['wl'] : 'administration/broadcasts' );
