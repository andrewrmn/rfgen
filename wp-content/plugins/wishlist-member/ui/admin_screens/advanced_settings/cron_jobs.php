<div class="page-header">
	<div class="row">
		<div class="col-md-9 col-sm-9 col-xs-8">
			<h2 class="page-title">
				<?php _e( 'Cron Settings', 'wishlist-member' ); ?>
			</h2>
		</div>
...
<div class="content-wrapper">
	<div class="row">
		<div class="col-md-12">
			...
			<h4><?php _e( 'Cron Job Details', 'wishlist-member' ); ?></h4>
			<h5><?php _e( 'Settings:', 'wishlist-member' ); ?></h5>
			<code>0 0 * * *</code>
			<br><br>
			<h5><?php _e( 'Command:', 'wishlist-member' ); ?></h5>
			<code>/usr/bin/wget -O - -q -t 1 <?php echo get_bloginfo('url'); ?>/?wlmcron=1</code>
			<ul>
				<li><?php _e( 'Copy and paste the line above into the command line of the Cron Job.', 'wishlist-member' ); ?></li>
				<li>
					<?php _e( 'Note: If the above command does not work, please try the following command:', 'wishlist-member' ); ?> <br>
					<code>/usr/bin/GET -d <?php echo get_bloginfo('url'); ?>/?wlmcron=1</code>
				</li>
			</ul>
		</div>
	</div>
