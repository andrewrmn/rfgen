...
<div class="row">
	...
	<div class="col-md-12">
		<div class="form-group mb-2">
			<textarea class="form-control email-editor" data-name="password_hint_email_message" name="password_hint_email_message" id="password_hint_email_message" skip-save="1"><?php echo $email_body; ?></textarea>
		</div>
	</div>
	<div class="col-md-12">
		<button class="btn -default -condensed email-reset-button" data-target="password_hint_email"><?php _e( 'Reset to Default', 'wishlist-member' ); ?></button>
		<template class="wlm3-form-group">{
			type : 'select',
