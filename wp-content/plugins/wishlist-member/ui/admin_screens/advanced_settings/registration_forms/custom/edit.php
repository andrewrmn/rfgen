...
<div id="regforms-create" style="display: none">
	<form id="regform-form">
			...
			<div class="large-form">
				<div class="row">
					<div class="col-sm-auto col-12">
						<h2 class="page-title"><?php _e( 'Form Name','wishlist-member' ); ?></h2>
					</div>
		...
		<div id="all-form-data">
			<h4 class="text-center"><?php _e( 'Drag and drop the desired fields from the list on the left to customize the registration form.', 'wishlist-member' ); ?></h4>
			<br>
			<div class="registration-form">
				<div class="row">
					<?php include 'edit/draggable_fields.php'; ?>
...
<?php
	include 'edit/field_template.php';
	include 'edit/field_edit_template.php';
?>
