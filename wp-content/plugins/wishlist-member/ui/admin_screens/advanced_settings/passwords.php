...
<div class="content-wrapper">
	...
	<div class="row">
		<?php $option_val = $this->GetOption('disable_password_change_email_for_admin') ?>
		<div class="col-md-6">
			<template class="wlm3-form-group">
				{
					label : '<?php _e( 'Disable "Password Changed" Admin Notification', 'wishlist-member' ); ?>',
					...
					class : 'wlm_toggle-switch notification-switch',
					type  : 'checkbox',
					tooltip: '<?php _e( 'By default, WordPress sends an email notification to the admin every time a user changes a password. Enabling this setting will turn this email notification off and the notifications will no longer be sent to the admin.', 'wishlist-member' ); ?>'
				}
			</template>
			<input type="hidden" name="action" value="admin_actions" />
			<input type="hidden" name="WishListMemberAction" value="save" />
