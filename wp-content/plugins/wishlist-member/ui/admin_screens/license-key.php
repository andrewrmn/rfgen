		...
		<div class="row align-items-center">
			...
			<div class="col-md-7">
				<div class="white-background">
					...
					<h4><?php _e( 'Congratulations, your license was successfully activated.', 'wishlist-member' ); ?></h4>
					<div class="row">
						<div class="col-md-12">
							<?php
							...
							<div class="panel-body">
								<p><label><strong><?php _e('License Key','wishlist-member');?>:</strong> ************************<?php echo substr($WPWLKey, -4); ?></label></p>
