<div class="page-header">
	<div class="row">
		<div class="col-md-9 col-sm-9 col-xs-8">
			<h2 class="page-title">
				<?php _e( 'Blacklist', 'wishlist-member' ); ?>
			</h2>
		</div>
	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6">
			...
			<div class="form-group">
				<p><?php _e( 'Enter the email addresses to Blacklist. One email address per line.', 'wishlist-member' ); ?></p>
				<textarea class="form-control" name="blacklist_email" cols="4" rows="5"><?php echo trim( $this->GetOption("blacklist_email") ); ?></textarea>
		...
		<div class="col-lg-6 col-md-6 col-sm-6">
			...
			<div class="form-group">
				<p><?php _e( 'Enter the IP addresses to Blacklist. One IP address per line.', 'wishlist-member' ); ?></p>
				<textarea class="form-control" name="blacklist_ip" cols="30" rows="5"><?php echo trim( $this->GetOption("blacklist_ip") ); ?></textarea>
				<small class="form-text text-muted" id="helpBlock">
					<em><?php _e( 'Example wildcards: 192.168.0.1, 192.168.0.*, 192.168.*', 'wishlist-member' ); ?></em>
