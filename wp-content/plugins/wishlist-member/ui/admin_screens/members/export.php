...
?>
<form action="<?php echo admin_url(); ?>" method="post" id="export-form" target="_parent">
	<div class="page-header">
		<div class="row">
			<div class="col-md-9 col-sm-9 col-xs-8">
				<h2 class="page-title">
					<?php _e( 'Export Members', 'wishlist-member' ); ?>
				</h2>
			</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="wpm_to[]" multiple="multiple" class="form-control wlm-select wlm-select-selectall select_mlevels" data-placeholder="Select Membership Levels">
								...
								<?php endforeach; ?>
							<option value="nonmember"><?php _e( 'Non-Members', 'wishlist-member' ); ?></option>
						</select>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<label for="">Additional Options</label>
					...
					<template class="wlm3-form-group">
						{
							label : '<?php _e( 'Export Full Data', 'wishlist-member' ); ?>',
							name  : 'full_data_export',
							id : 'full_data_export',
							value : '1',
							type  : 'checkbox',
							tooltip: '<?php _e( 'All data fields associated with the Member user profiles will be exported. This includes any custom fields that may be associated with the members.', 'wishlist-member' ); ?>',
							tooltip_size: 'md',
							column: 'mb-2',
						}
					</template>
					<template class="wlm3-form-group">
						{
							label : '<?php _e( 'Include Password (Encrypted)', 'wishlist-member' ); ?>',
							name  : 'include_password',
							id : 'include_password',
							value : '1',
							type  : 'checkbox',
							tooltip: '<?php _e( 'Passwords will be encrypted and included in the export. They will be shown as random characters in the exported file.', 'wishlist-member' ); ?>',
							tooltip_size: 'md',
							column: 'mb-2',
						}
					</template>
					<template class="wlm3-form-group">
						{
							label : '<?php _e( 'Include Inactive Members', 'wishlist-member' ); ?>',
							name  : 'include_inactive',
							id : 'include_inactive',
							value : '1',
							type  : 'checkbox',
							tooltip: '<?php _e( 'Any Cancelled or Expired Members are considered as Inactive Members.', 'wishlist-member' ); ?>',
							tooltip_size: 'md'
						}
					</template>
					<!-- end: v4 -->
	...
	<div class="row">
		<div class="col-md-12">
			<div class="export-progress">
				...
				<div class="text-danger text-center"><?php _e("Please do not close your browser while the export is ongoing", "wishlist-member")?></div>
			</div>
			<br />
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-12 text-right">
				<a href="#" class="btn -primary start-export">
					...
					<span class="text"><?php _e( 'Export Members', 'wishlist-member' ); ?></span>
				</a>
			</div>
		</div>
	</div>
