			...
			<div class="row">
				<div class="col-md-12">
					<template class="wlm3-form-group">
						{
							addon_left : '<?php _e( 'When a Member is Added to This Level', 'wishlist-member' ); ?>',
							type : 'select',
							options : [
								{ value: '1', text : '<?php _e( 'Send Email', 'wishlist-member' ); ?>' },
								{ value: '2', text : '<?php _e( 'Send Email ONLY for New Members', 'wishlist-member' ); ?>' },
								{ value: '0', text : '<?php _e( 'Do NOT Send Email', 'wishlist-member' ); ?>' },
							],
							name : 'newuser_notification_admin',
							tooltip : '<?php _e( 'The New Member Registration Email is sent to the site admin.', 'wishlist-member' ); ?>',
						}
					</template>
				</div>
			</div>
					...
					<template class="wlm3-form-group">
						{
							...
							options : [
								{ value: '1', text : '<?php _e( 'Send Email', 'wishlist-member' ); ?>' },
								{ value: '2', text : '<?php _e( 'Send Email ONLY to New Members', 'wishlist-member' ); ?>' },
								{ value: '0', text : '<?php _e( 'Do NOT Send Email', 'wishlist-member' ); ?>' },
							],
