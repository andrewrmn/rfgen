<div role="tabpanel" class="tab-pane" id="" data-id="levels_notifications">
	<div class="content-wrapper">
		<div class="row">
			<div class="col-md-4 col-sm-5">
				<label class="-standalone">
					<?php _e( 'New Member Registration', 'wishlist-member' ); ?>
		...
		<div class="row">
			<div class="col-md-4 col-sm-5">
				<label class="-standalone">
					<?php _e( 'Incomplete Registration', 'wishlist-member' ); ?>
		...
		<div class="row">
			<div class="col-md-4 col-sm-5">
				<label class="-standalone">
					<?php _e( 'Membership Cancelled', 'wishlist-member' ); ?>
		...
		<div class="row">
			<div class="col-md-4 col-sm-5">
				<label class="-standalone">
					<?php _e( 'Membership Uncancelled', 'wishlist-member' ); ?>
