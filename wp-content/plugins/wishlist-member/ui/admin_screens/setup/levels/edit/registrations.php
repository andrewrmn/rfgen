...
<div class="row">
	<template class="wlm3-form-group">
		{
			column : 'col',
			label : '<?php _e( 'Automatically Add non-WishList Member User Registrations to this Level', 'wishlist-member' ); ?>',
			name  : 'autoadd_other_registrations',
			tooltip : '<?php _e( 'Enabling this option will automatically add the user to the Level if they join through a non-WishList Member registration option on the site. For example, the WordPress registration or a 3rd party registration form on the WordPress site. Registration needs to happen on the WordPress site for this to function.', 'wishlist-member' ); ?>',
			value : '1',
			uncheck_value : '0',
			tooltip_size: 'md',
			type : 'toggle-switch'
