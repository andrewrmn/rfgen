		...
		<form id="recaptcha-settings-form">
			<div class="row">
				<template class="wlm3-form-group">{
					label : '<?php _e( 'reCAPATCHA Site Key', 'wishlist-member' ); ?>',
					name : 'recaptcha_public_key',
					value : <?php echo json_encode( $this->GetOption( 'recaptcha_public_key' ) ); ?>,
					type : 'text',
					column : 'col-md-12'
				}</template>
				<template class="wlm3-form-group">{
					label : '<?php _e( 'reCAPTCHA Secret Key', 'wishlist-member' ); ?>',
					name : 'recaptcha_private_key',
					value : <?php echo json_encode( $this->GetOption( 'recaptcha_private_key' ) ); ?>,
					type : 'text',
					column : 'col-md-12'
				}</template>
				<div class="col-md-12">
					<p>No reCAPTCHA Key? <a href="https://www.google.com/recaptcha/admin" target="_blank"><?php _e( 'Click here to get one for free.', 'wishlist-member' ); ?></a></p>
				</div>
			</div>
