		...
		<div class="row">
			...
			<div class="col-12 col-md-auto text-center">
				<div class="content m-auto h-100 w-auto pt-3 pt-md-2">
					...
					<button class="btn -primary -condensed float-right float-sm-none"><?php _e( 'Choose...', 'wishlist-member' ); ?></button>
					
					<a href="#" class="btn -bare -condensed img-clear-button float-left float-sm-none d-sm-block mt-sm-3 mr-sm-0 mr-3"><?php _e( 'Clear', 'wishlist-member' ); ?></a>
				</div>
			</div>
		</div>
	</div>						
		...
		switch(this.data.type) {
			case 'wlm3media':
				...
				if(!this.data.placeholder) {
					this.data.placeholder = '<?php _e( 'Choose an Image', 'wishlist-member' ); ?>';
				}
				var el = $('<input/>');
